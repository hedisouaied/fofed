                        ...
                        <div class="row h-100 align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="welcome_slide_text">
                                    ...
                                    <a href="{{$banner->slug}}" class="btn btn-primary" data-animation="fadeInUp" data-delay="900ms">Shop maintenant</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single_catagory_area mt-50">
                        <a href="{{route('product.category',$cat->slug)}}">
                            <img src="{{$cat->photo}}" alt="{{$cat->title}}" style="width: 100%" >
                        </a>
                    </div>
                </div>
                @endforeach
                    ...
                    <div class="new_arrivals_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="{{$photo[0]}}" alt="{{ucfirst($nproduct->title)}}">
                                <img class="hover_img" src="{{$photo[1]}}" alt="{{ucfirst($nproduct->title)}}">
